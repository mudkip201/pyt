...
#parse(u"←Đ³⇹5*+6+₆")                       #125
#parse(u"←Đ5+Ḟ⇹⁺-")                         #126
#parse(u"←Đ5+Ḟ⇹Đ⁺*₂-3-")                    #128
#parse(u"←Đ12√+⇹^12√-⇹↔^-22√*/")            #129
#parse(u"2←ĐĐ3*!3Ș↔*↔2*⁺!⇹⁺!*/")            #139
#parse(u"←!")                               #142
#parse(u"←ǝ⌊")                              #149
#parse(u"←2*‼")                             #165
#parse(u"←!é/½+1↑")                         #166
#parse(u"←ĐĐĐ3⇹^⇹2*!*2*⇹!↔2+!⇹↔*/")         #168
#parse(u"←ř!Π")                             #178
#parse(u"←Ļ⎶")                              #193
#parse(u"←√⎶")                              #194
#parse(u"←Ļ⌊")                              #195
...
#parse(u"é←^⎶")                             #227
#parse(u"3←^")                              #244
#parse(u"3←ĐĐ2*!3Ș⁺⁺!⇹⁻!*/*")               #245
#parse(u"←Đ2⇹^⇹-⁻⁻")                        #247
#parse(u"←2*0`ŕ₂2%ł")                       #265
#parse(u"←4*+1√⌊")                          #267
#parse(u"←Đ2-^")                            #272
#parse(u"←Đ3*⇹4*5+√⌊~+5+")                  #277
#parse(u"←Đ2+ŘḞ↕Ʃ")                         #285
#parse(u"←²")                               #290
#parse(u"←Đ2+ŘΠ₆")                          #292
#parse(u"←Đ2⇹^⇹-⁻")                         #295
#parse(u"←ĐĐ⁺⇹3+↔8+Π₆")                     #297
#parse(u"4←^")                              #302
#parse(u"←Ṗ")                               #312
#parse(u"←Đ2⇹")                             #325
#parse(u"←⬠")                               #326
...
#parse(u"←4ć")                              #332
#parse(u"←Đ⁻⇹2⇹^*⁺")                        #337
#parse(u"5←ĐĐ2*⇹-2ć⇹3-/*")                  #344
#parse(u"22←Đ⁺Đ2*⇹ć↔3Ș*⁺^")                 #346
#parse(u"5←^")                              #351
#parse(u"←Đ!²⇹Đ⁺!⇹Đ2+!⇹4Ș**⇹2*Đ⁺!⇹!*/⅟")    #356
#parse(u"←Đ5⇹^⇹Đ2*⁻⇹Đ3⇹^⇹Đ²2*⇹2*-2-3Ș*~++") #363
# - DOABLE                                  #371
#parse(u"←Đ2*⁻*")                           #384
#parse(u"←½↑2*⁻ř²Ʃ")                        #447
#parse(u"←ř⁴Ʃ")                             #538
